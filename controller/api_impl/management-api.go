...
func NewManagementApiFactory(nodeId identity.Identity, network *network.Network, xmgmts []xmgmt.Xmgmt, securityPipeRegistry *datapipe.Registry) *ManagementApiFactory {
